const questions = [
    {
        question: "How often do lunar eclipses happen each year?", done
        answers: [
    ...
    {
        question: 'In "The Gang Hits the Road", what fruit does Charlie eat for the very first time?', done
        answers: [
    ...
    {
        question: "According to Birdperson, in Rick and Morty what does "Wubba Lubba dub- dub" mean?", done
        answers: [
...
{
    question: "A(n) ________ can filter 50 gallons of water a day.", done;
    answers: [
...
{
    question: "Beijing has three million _______ that are looked after by robot nannies.", done;
    answers: [
...
{
    question: "How many constellations are there?", done;
    answers: [
...
{
    question: "Starfish have ______ on the tips of their arms", done;
    answers: [
...
{
    question: "Which planet has the largest ocean?", done;
    answers: [
...
{
    question: "How long does each season last on Neptune?", done;
    answers: [
...
{
    question: "What is at the center of the Milky Way galaxy?", done;
    answers: [
...
{
    question: "How much of the Milky Way is visible?", done;
    answers: [
...
{
    question: "In Rick and Morty, What's the name of the colorful land Rick created for Beth when she was a kid?", done;
    answers: [
...
{
    question: "In Rick and Morty,What is Morty's dragon's name?",  done
        answers: [
...
{
    question: "In Rick and Morty, When exactly did Snake Armageddon happen?", done;
    answers: [
...
{
    question: "Where is the strongest human muscle located? ", done
        answers: [
...
{
    question: "How many hearts does an octopus have?",  done
        answers: [
...
{
    question: "What is a group of flamingos called?", done
        answers: [
...
{
    question: "In the film Predator What color is the Predator's blood?",  done
        answers: [
...
{
    question: "In the film Predator Who says: 'I ain't got time to bleed'?",  done
        answers: [
